                      ...
                      <div className="col-sm-6">
                        <div className="banner_taital_main">
                          ...
                          <div className="btn_main">
                            <div className="started_text"><Link to="#">Buy Now</Link></div>
                            <div className="started_text active"><Link to="#">Contact Us</Link></div>
                          </div>
                        </div>
                      </div>
                      <div className="col-sm-6">
                        <div className="banner_img"><img src="images/banner-img.png" alt=""/></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-md-12">
                    ...
                    <div className="client_main">
                      <div className="client_left">
                        <div className="client_img"><img src="images/client-img.png" alt=""/></div>
                      </div>
